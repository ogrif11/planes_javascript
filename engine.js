...
function init_engine(debug){
	...
	engine.get_new_state_object = function(args){
		...
		a.push({"id":6,"name":"Warwick","sizeMillions":3,"activated":true,"jobs":[],position:{latitude:-27.8140000,longitude:150.9633200}});
		...
		ps.push(s);
		var a = {"id":5,"model":"Cessna","speed":5,"jobs_onboard":[],"itinerary":[],status:"",next_airport_id:2,takeoff_time:0,position:{},"last_airport_object":{},"next_airport_object":a[1],"arrives_at":0,"capacity_people":2,"capacity_cargo":5};
		ps.push()
